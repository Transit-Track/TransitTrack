...
import 'package:transittrack/features/authentication/presentation/pages/send_otp_verification_page.dart';
...
import 'package:transittrack/features/home/presentation/pages/test_page.dart';
...
class AppRouter {
  static final GoRouter router =
      GoRouter(initialLocation: AppPath.test, routes: <GoRoute>[
    GoRoute(
     ...
     GoRoute(
       ...
       GoRoute(
        ...
        GoRoute(
        path: AppPath.sendOtpVerification,
        name: AppPath.sendOtpVerification,
        builder: (BuildContext context, GoRouterState state) {
          return const SendOtpVerificationPage();
        }),
        GoRoute(
